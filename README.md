...
__목표__: 시작 시간과 종료 시간, 주식 코드 및 필드를 입력받아 해당 기간 동안 요청된 필드에 대한 데이터를 반환하여 REST API를 구현 및 시계열 데이터베이스(QuestDB)와 NoSQL(MongoDB)에 데이터를 제공, 두 데이터베이스의 성능 분석
...
실행 시 화면: <br />
[Task 3.2_Processing_2.png](Task%203/Task%203.1_Processing_1.png)
